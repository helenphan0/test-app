...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.applyMiddleware)()(_redux.createStore);

	_reactDom2.default.render(_react2.default.createElement(
	  _reactRedux.Provider,
	  { store: store(_reducers2.default) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checkedList = __webpack_require__(207);

	var _checkedList2 = _interopRequireDefault(_checkedList);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_checkedList2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _add_item = __webpack_require__(202);
	...
	var Input = function (_Component) {
		...
		_createClass(Input, [{
			...
			value: function onFormSubmit(event) {
				event.preventDefault();
				var word = this.state.input.trim();
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { type: 'text', value: this.state.input, onChange: this.onInputChange }),
						_react2.default.createElement(
							'button',
							{ type: 'submit' },
							'Add'
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ addItem: _add_item.addItem }, dispatch);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = function (_Component) {
		...
		_createClass(List, [{
			key: 'listItem',
			value: function listItem(item, i) {
				return _react2.default.createElement(_item2.default, { index: i, key: i, item: item });
			}
		}, {
			key: 'render',
			value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _remove_item = __webpack_require__(205);

	var _add_checked_item = __webpack_require__(206);
	...
	var Item = function (_Component) {
		...
		_createClass(Item, [{
			key: 'checkItem',
			value: function checkItem(event) {
				var checkedItem = event.target.parentElement.getAttribute('data-name');
			...
			value: function handleRemove(event) {
				var itemName = event.target.parentElement.getAttribute('data-name');
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'item', key: this.props.index },
					_react2.default.createElement(
						'p',
						{ 'data-name': this.props.item, className: 'item-text' },
						this.props.item
					),
					_react2.default.createElement(
						'div',
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ removeItem: _remove_item.removeItem, addCheckedItem: _add_checked_item.addCheckedItem }, dispatch);
	}
...
/***/ function(module, exports) {
	...
	exports.addCheckedItem = addCheckedItem;
	var ADD_CHECKED_ITEM = exports.ADD_CHECKED_ITEM = 'ADD_CHECKED_ITEM';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checkedItem = __webpack_require__(208);

	var _checkedItem2 = _interopRequireDefault(_checkedItem);
	...
	var CheckedList = function (_Component) {
		_inherits(CheckedList, _Component);

		function CheckedList() {
			_classCallCheck(this, CheckedList);

			return _possibleConstructorReturn(this, (CheckedList.__proto__ || Object.getPrototypeOf(CheckedList)).apply(this, arguments));
		}

		_createClass(CheckedList, [{
			key: 'listCheckedItem',
			value: function listCheckedItem(item, i) {
				return _react2.default.createElement(_checkedItem2.default, { index: i, key: i, item: item });
			}
		}, {
			key: 'render',
			value: function render() {
	...
	function mapStateToProps(_ref) {
		var checkItems = _ref.checkItems;

		return { checkItems: checkItems };
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps)(CheckedList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _remove_checked_item = __webpack_require__(209);
	...
	var CheckedItem = function (_Component) {
		_inherits(CheckedItem, _Component);

		function CheckedItem(props) {
			_classCallCheck(this, CheckedItem);

			// We need to bind the component to the method
			var _this = _possibleConstructorReturn(this, (CheckedItem.__proto__ || Object.getPrototypeOf(CheckedItem)).call(this, props));
		...
		_createClass(CheckedItem, [{
			key: 'checkItem',
			value: function checkItem(event) {
				var uncheckedItem = event.target.parentElement.getAttribute('data-name');
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						{ 'data-name': this.props.item, className: 'item-text checked' },
						this.props.item
					),
					_react2.default.createElement(
						'div',
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ removeCheckedItem: _remove_checked_item.removeCheckedItem, addItem: _add_item.addItem }, dispatch);
	}

	// the first argument represents the state (ex mapStateToProps), 
	// but this container doesn't care about state, 
	// so we pass in null
	exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(CheckedItem);
...
/***/ function(module, exports) {
	...
	exports.removeCheckedItem = removeCheckedItem;
	var REMOVE_CHECKED_ITEM = exports.REMOVE_CHECKED_ITEM = 'REMOVE_CHECKED_ITEM';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handle_item_reducer = __webpack_require__(211);

	var _handle_item_reducer2 = _interopRequireDefault(_handle_item_reducer);

	var _check_item_reducer = __webpack_require__(212);

	var _check_item_reducer2 = _interopRequireDefault(_check_item_reducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  items: _handle_item_reducer2.default,
	  checkItems: _check_item_reducer2.default
	}); // reducers combined
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		...
		switch (action.type) {
			case _add_item.ADD_ITEM:
				return [action.payload].concat(_toConsumableArray(state)); // same as state.concat([ action.payload.data])
			case _remove_item.REMOVE_ITEM:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		...
		switch (action.type) {
			case _add_checked_item.ADD_CHECKED_ITEM:
				return [action.payload].concat(_toConsumableArray(state)); // same as state.concat([ action.payload.data])
			case _remove_checked_item.REMOVE_CHECKED_ITEM:
				var array = state.slice(0);
				var index = array.indexOf(action.payload);
				if (index > -1) {
					array.splice(index, 1);
